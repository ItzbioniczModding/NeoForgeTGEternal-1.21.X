...
@Mod(TGEternal.MODID)
public class TGEternal {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "tgeternal";
    ...
    @EventBusSubscriber(modid = TGEternal.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
